...
from app.api import admin_departments, admin_users, auth, chat, file, health, metrics
...
def create_app(
    *,
    ...
    application.include_router(admin_departments.router, prefix="/api", tags=["管理员部门"])
