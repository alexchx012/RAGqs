...
export function Chip({
  ...
  return (
    <button
      ...
      aria-expanded={open}
      className={
        'ui-touch-target [--touch-expand:-6px] inline-flex h-8 items-center gap-1.5 ' +
        'rounded-[var(--radius-buttons)] border border-[var(--color-hairline)] px-3 ' +
        'text-[14px] text-ink-black transition-colors ' +
    ...
    >
      ...
      {/* 截断兜底（审查 A8）：200px 截断后 title 悬停看全文；children 非纯文本时不加。 */}
      <span
